...
function Dashboard() {
  ...
  <div className='col'>
  <div className="container text-center mt-2">
  <Link to={`/bugs/medium`}><div className="card border border-5  border-primary rounded text-center" style={{width:"18rem"}}>
  ...
  <div className='col'>
    ...
    <Link to={`/bugs/high`}><div className="card border border-5  border-primary rounded text-center" style={{width:"18rem" }}>
